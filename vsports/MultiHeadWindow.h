#ifndef __MultiHead_WINDOW_H__
#define __MultiHead_WINDOW_H__
...
// #include <GL/glut.h>
// #include <GL/glew.h>
class MultiHeadWindow : public SimWindow{
public:
	MultiHeadWindow();
	MultiHeadWindow(const char* nn_path, const char* control_nn_path);
