...
# 		env.setAction(action, 0, 0)
# 		observation = env.getState(0,0)
# 		reward = env.getReward(0,0)
# 		done = True
# 		info = {"A" : "is B"}
...
class VSEnv(gym.Env, utils.EzPickle):
    ...
    def __init__(
        ...
        ''' should handle this part '''
        self.ale = atari_py.ALEInterface()
        ''' should handle this to use viwer '''
        self.viewer = None
    ...
    def step(self, a):
        ...
        for i in range(1):
            for j in range(2):
                self.mEnv.getState(i, j)
            self.mEnv.stepAtOnce(i)
